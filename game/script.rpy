...
screen main_menu():
    ...
    imagebutton auto "gui/start_%s.png" xpos 60 ypos 343 focus_mask None action Start()
    imagebutton auto "gui/load_%s.png" xpos 60 ypos 415 focus_mask None action ShowMenu('load')
    imagebutton auto "gui/preferences_%s.png" xpos 60 ypos 485 focus_mask None action ShowMenu('preferences')
    imagebutton auto "gui/about_%s.png" xpos 60 ypos 554 focus_mask None action ShowMenu('about')
    ...
    imagebutton auto "gui/quit_%s.png" xpos 60 ypos 621 focus_mask None action Quit()
